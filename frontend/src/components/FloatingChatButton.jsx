...
function FloatingChatButton({ onClick }) {
    return (
        <button
            onClick={onClick}
            className="btn btn-primary btn-circle btn-lg fixed bottom-6 right-6 z-40 shadow-lg transition-transform transform hover:scale-105" // DaisyUI button classes
